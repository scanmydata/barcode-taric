...
class SettingsPage(QWidget):
    ...
    def __init__(self, parent=None) -> None:
        ...
        self.captcha_solver = QComboBox()
        self.captcha_solver.addItems(["none", "capsolver", "2captcha", "anticaptcha", "capmonster", "deathbycaptcha", "9kw"])
        self.captcha_solver.setCurrentText(str(SETTINGS.get("captcha_solver", "none")))
        web_l.addRow("Captcha solver", self.captcha_solver)
        self.captcha_key = QLineEdit(str(SETTINGS.get("captcha_provider_api_key") or ""))
        self.captcha_key.setEchoMode(QLineEdit.Password)
        self.captcha_key.setPlaceholderText("API key για solver")
        web_l.addRow("Captcha API key", self.captcha_key)
    ...
    def save(self) -> None:
        ...
        SETTINGS.set("captcha_solver", self.captcha_solver.currentText())
        SETTINGS.set("captcha_provider_api_key", self.captcha_key.text().strip())
